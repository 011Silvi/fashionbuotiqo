...
<i class="fa fa-dashboard"> </i> Dashboard / Memasukkan Bundle
...
<i class="fa fa-money fa-fw"></i> Memasukkan Bundle
...
<label class="col-md-3 control-label" > Nama Bundle </label>
...
<label class="col-md-3 control-label" > URL Bundle </label>
...
Contoh URL Bundle : navy-blue-t-shirt
...
<label class="col-md-3 control-label" > Harga Bundle </label>
...
<label class="col-md-3 control-label" > Diskon Harga Bundle </label>
...
<label class="col-md-3 control-label" > Kata Kunci Bundle </label>
...
<label class="col-md-3 control-label" > Tab Bundle </label>
...
<a data-toggle="tab" href="#description"> Deskripsi Bundle </a>
...
<a data-toggle="tab" href="#video"> Suara Dan Video </a>
...
<label class="col-md-3 control-label" > Label Bundle </label>
...
echo "<script>alert('Bundle Telah Berhasil Dimasukkan')</script>";
