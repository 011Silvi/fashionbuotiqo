...
$mitra_session = $_SESSION['mitra_email'];

$get_mitra = "select * from mitra  where mitra_email='$mitra_session'";

$run_mitra = mysqli_query($con,$get_mitra);

$row_mitra = mysqli_fetch_array($run_mitra);

$mitra_id = $row_mitra['mitra_id'];

$mitra_name = $row_mitra['mitra_name'];

$mitra_email = $row_mitra['mitra_email'];

$mitra_image = $row_mitra['mitra_image'];

$mitra_country = $row_mitra['mitra_country'];

$mitra_job = $row_mitra['mitra_job'];

$mitra_contact = $row_mitra['mitra_contact'];

$mitra_about = $row_mitra['mitra_about'];
