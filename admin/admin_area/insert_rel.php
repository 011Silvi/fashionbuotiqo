...
<i class="fa fa-dashboard"></i> Dashboard / Memasukkan Hubungan
...
<i  class="fa fa-money fa-fw"></i> Memasukkan Hubungan
...
<label class="col-md-3 control-label"> Nama Hubungan  </label>
...
echo "<script>alert('Relasi Baru Telah Dimasukkan')</script>";
