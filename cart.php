  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">LIHAT</span> Keranjang
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<p class="text-muted" > Anda sekarang memiliki <?php echo $count; ?> item(s) di keranjang Anda. </p>
...
<i class="fa fa-chevron-left"></i> Lanjutkan Pembelian
...
Lanjutkan ke Checkout <i class="fa fa-chevron-right"></i>
...
echo "<script>alert('Kupon Anda Telah Kadaluwarsa')</script>";
...
echo "<script>alert('Kupon Anda Telah Digunakan')</script>";
...
echo "<script> alert('Kupon Anda Tidak Valid') </script>";
...
<h3 class="text-center"> Anda Mungkin Suka Produk Ini </h3>
...
<p class="text-muted">
Biaya pengiriman dan biaya tambahan telah ditambahkan ke dalam pesanan Anda.
</p>
