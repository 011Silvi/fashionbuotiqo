...
<i class="fa fa-dashboard"></i> Dashboard / Memasukkan Term
...
<i class="fa fa-money fa-fw"></i> Memasukkan Term
...
<label class="col-md-3 control-label"> Nama Term </label>
...
<label class="col-md-3 control-label"> Deskripsi Term </label>
...
<label class="col-md-3 control-label"> Link Term </label>
...
echo "<script>alert('Term Baru Telah Dimasukkan')</script>";
