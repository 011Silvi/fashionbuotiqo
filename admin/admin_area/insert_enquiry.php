...
<i class="fa fa-dashboard" ></i> Dashboard / Masukkan Jenis Pertanyaan
...
<i class="fa fa-money fa-fw"></i> Masukkan Jenis Pertanyaan 
...
<label class="col-md-3 control-label"> Nama Pertanyaan </label>
...
echo "<script> alert('Jenis Pertanyaan Baru Telah Dimasukkan') </script>";
