...
<i class="fa fa-dashboard"></i> Dashboard / Lihat Customer
...
<i class="fa fa-money fa-fw"></i> Lihat Customer
...
<div class="panel-heading">
    ...
    <div class="panel-options">
        <a href="report_customer_excel.php?type=excel" class="btn btn-success btn-sm">
            <i class="fa fa-file-excel-o"></i> Report to Excel
        </a>
        <a href="report_customer.php?type=pdf" class="btn btn-danger btn-sm">
