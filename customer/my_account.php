  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Akun </span>Anda
      </div>
      <p class="nero__text">
      </p>
    </div>
...
<strong> Peringatan! </strong> Mohon Konfirmasi Email Anda dan jika belum menerima email konfirmasi
...
echo "<script>alert('Email Anda Sudah Terkonfirmasi')</script>";
...
echo "<script>alert('Email Konfirmasi telah dikirimkan kepada Anda, periksa inbox Anda')</script>";
