...
echo "<script> alert('Maaf, Email Anda Tidak Ada') </script>";
...
<h1 align='center'> Password Anda Telah Dikirimkan </h1>

<h2 align='center'> Dear $c_name </h2>

<h3 align='center'>

Password anda : <span> <b>$c_pass</b> </span>
...
Klik disini untuk login ke akun anda
...
echo "<script> alert('Password Anda Telah Dikirimkan, cek inbox Anda ') </script>";
