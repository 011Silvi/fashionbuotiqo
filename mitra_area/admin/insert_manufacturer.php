...
<i class="fa fa-dashboard"></i> Dashboard / Memasukkan Produsen
...
<i class="fa fa-money fa-fw"> </i> Memasukkan Produsen
...
<label class="col-md-3 control-label"> Tampilkan Produsen Teratas </label>
...
echo "<script>alert('Produsen Baru Telah Dimasukkan')</script>";
