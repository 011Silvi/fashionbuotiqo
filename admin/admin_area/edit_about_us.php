...
<i class="fa fa-dashboard" ></i> Dashboard / Halaman Edit About Us
...
<i class="fa fa-money fa-fw"></i> Halaman Edit About Us
...
<label class="col-md-3 control-label"> Heading About Us : </label>
...
<label class="col-md-3 control-label"> Deskripsi Singkat About Us : </label>
...
<label class="col-md-3 control-label"> Deskripsi About Us : </label>
...
echo "<script>alert('Halaman About Us Telah Diupdate')</script>";
