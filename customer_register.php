  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Register</span> di Buotiqo
      </div>
      <p class="nero__text">
      </p>
    </div>
...
echo "<script>alert('Email sudah terdaftar, silahkan daftarkan email lain.')</script>";
...
Klik disini untuk konfirmasi email
...
echo "<script>alert('Silahkan pilih Captcha')</script>";
