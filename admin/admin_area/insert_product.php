...
<i class="fa fa-dashboard"> </i> Dashboard / Memasukkan Produk
...
<i class="fa fa-money fa-fw"></i> Memasukkan Produk
...
Contoh URL Produk : navy-blue-t-shirt
...
<label class="col-md-3 control-label" > Diskon Harga Produk </label>
...
echo "<script>alert('Produk Telah Berhasil Dimasukkan')</script>";
