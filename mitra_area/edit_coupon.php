...
coupon_price='$coupon_price',coupon_code='$coupon_code',coupon_limit='$coupon_limit',coupon_used='$c_used' where coupon_id='$c_id'";
...
echo "<script>alert('Satu Kupon Telah Diupdate')</script>";
