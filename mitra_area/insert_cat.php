...
<i class="fa fa-dashboard"></i> Dashboard / Memasukkan Category
...
<i class="fa fa-money fa-fw"></i> Memasukkan Category
...
<label class="col-md-3 control-label">Tampilkan Kategori Teratas</label>
...
echo "<script> alert('Kategori Baru Telah Berhasil Dimasukkan')</script>";
