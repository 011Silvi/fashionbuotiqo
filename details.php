  ...
  <main>
    ...
    <div class="nero">
      <div class="nero__heading">
        <span class="nero__bold">Lihat </span>Produk
      </div>
      <p class="nero__text">
      </p>
    </div>
...
echo "<script>alert('Produk ini sudah ditambahkan di keranjang')</script>";
...
<label class="col-md-5 control-label" >Jumlah Bundle</label>
...
<label class="col-md-5 control-label" >Ukuran Bundle</label>
...
Harga Produk : <del> $$pro_price </del><br>

Harga Diskon Produk : $$pro_psp_price
...
Harga Bundle : <del> $$pro_price </del><br>

Harga Diskon Bundle : $$pro_psp_price
...
<i class="fa fa-heart" ></i> Masukkan Wishlist
...
echo "<script>alert('Silahkan Lakukan Login untuk Menambahkan ke Wishlist')</script>";
...
echo "<script>alert('Produk Ini Telah Ditambahkan Dalam Wishlist')</script>";
...
echo "<script> alert('Produk Telah Dimasukkan Ke Dalam Wishlist') </script>";
...
<h3 class="text-center"> Anda mungkin juga menyukai Produk ini: 3 item produk teratas. </h3>
...
<h3 class="text-center"> Produk Bundle </h3>
