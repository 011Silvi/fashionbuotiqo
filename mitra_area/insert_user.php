...
<i class="fa fa-dashboard" ></i> Dashboard / Memasukkan User
...
<i class="fa fa-money fa-fw" ></i> Memasukkan User
...
<label class="col-md-3 control-label">Negara User: </label>
...
<label class="col-md-3 control-label">Pekerjaan User: </label>
...
<label class="col-md-3 control-label">Kontak User: </label>
...
<label class="col-md-3 control-label">Tentang User: </label>
...
<label class="col-md-3 control-label">Foto Profil User: </label>
...
echo "<script>alert('Satu User Telah Berhasil Dimasukkan')</script>";
