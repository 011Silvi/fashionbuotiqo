...
<i class="fa fa-dashboard" ></i> Dashboard / Edit Jenis Pertanyaan
...
<i class="fa fa-money fa-fw"></i> Edit Jenis Pertanyaan 
...
echo "<script>alert('Satu Jenis Pertanyaan Telah Diupdate')</script>";
